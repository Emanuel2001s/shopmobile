...
require_once 'include/cart_functions.php'; // Incluir funções do carrinho
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['add_to_cart'])) {
    ...
    header("Location: product.php?id=" . $product_id); // Redireciona para evitar reenvio do formulário
    exit();
}
...
<head>
    ...
    <style>
        ...
        .main-image {
            ...
            height: 100%;
            object-fit: cover;
            border-radius: 15px; /* Mantém o border-radius no container */
        }
        ...
        /* Estilos para dispositivos móveis - Container expansível */
        ...
        @media (max-width: 767px) {
            ...
            .product-content {
                padding-bottom: 200px; /* Espaço para o botão de toggle e formulário expandido */
            }
        }
    ...
    <script>
        ...
        function toggleMobilePurchase() {
            ...
            if (purchaseSection.classList.contains("mobile-expanded")) {
                ...
                toggleButton.style.display = "flex"; // Garante que o botão de toggle esteja visível
            } else {
                // Expandir
                ...
                toggleButton.style.display = "none"; // Oculta o botão de toggle quando expandido
            }
        }
        ...
        async function handlePurchase(event) {
            ...
            const orderData = {
                ...
                cidade: data.cidade || '',
                cep: data.cep || '',
                produto_id: <?php echo $produto_id; ?> // Assumindo que o pedido é para o produto atual da página
            };
